...
global.owner = process.env.OWNER_NUMBER  || '94701992015' ;  // ADD YOUR NUMBER WITHOUT +923492147102
    
module.exports = {
SESSION_ID: process.env.SESSION_ID |VAJIRA-MD=yd9gxbIJ#UErl88p6srnBCpf0F5OSyvJjfoBRoLntoBPCntgOKzA| ' ' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "92492147102" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'ASIFSHEHZADA' ,
